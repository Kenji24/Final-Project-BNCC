        ...
        <div style="background-color: white; display:flex; flex-direction:row; width: 90%; gap: 7px; padding: 10px; filter: drop-shadow(20px 4px 20px rgba(97, 97, 97, 0.15));">
            ...
            <div style="display:flex; flex-direction:column; gap: 5px; width: 100%; padding: 5px">
                ...
                <div style="display:flex; flex-direction:row; gap: 10px; align-items:center;">
                    ...
                    @else
                        <div class="stock-display" style="color: red">Stok Habis</div>
                    @endif

                </div>
                <div style="display: flex; flex-direction: row; gap: 5px; padding-top: 20px; padding-bottom: 20px; border-block-end: 2px solid black;">
                    ...
                    @else
                        {{-- <button class="submit primaryBtn" style="width: 315px; background: #D9D9D9; color: #1E87C8" disabled>Stok habis</button> --}}
                        <div class="secondaryBtn" style="width: 100%; border-color: red; color:red;">stock habis</div>
                    @endif
                </div>
                <div>
                    {{ $toy->description }}
