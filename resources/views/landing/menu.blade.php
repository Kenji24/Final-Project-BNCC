            ...
            <div class="col-3 my-3">
                <a href="{{ route('product.detail', $toy) }}" style="text-decoration: none">
                    <div class="product-card">
                        <div class="">
                            <img src="{{ $toy->image ? asset('image/product images/' . $toy->image) : asset('image/product images/1720887954_121640-limited-production-figma-eris-boreas-greyrat-mushoku-tensei.jpg') }}"  class="w-100 product-image" />
                        </div>
                        <div>
